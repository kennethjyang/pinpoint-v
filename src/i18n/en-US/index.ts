export default {
  ...
  probeInspector: {
    ...
    bodyModelTransformChain: "Body Model Transform Chain",
  ...
  preferences: {
    ...
    transformInputNamesTitle: "Transform Input Names",
    transformInputNamesHint:
      "These names label the twelve inputs every 3D model is posed from.",
    transformInputNameLabel: "{group} {axis} name",
    axisAp: "AP",
    axisDv: "DV",
    axisMl: "ML",
    axisRoll: "Roll",
    ...
    transformChainsTitle: "Transform Chains",
    defaultProbeChain: "Default probe chain",
    defaultProbeChainHint: "New probes are created with this chain.",
    chainLibrary: "Chains",
    editChain: "Edit {name}",
    builtInChain: "Built-in chain",
    builtInChainHint: "Built-in chains cannot be edited or deleted.",
    addChain: "Add chain",
    deleteChain: "Delete chain",
    chainCopyName: "{name} copy",
    chainName: "Chain name",
    chainSteps: "Steps",
    noSteps: "This chain has no steps, so the model never leaves its parent.",
    addStep: "Add step",
    ...
    argumentSource: "{axis} source",
    fixedValue: "Fixed value",
    transformInputOption: "{group}: {name}",
    depthAxis: "Depth axis",
    depthAxisHint: "Move to surface advances the model along this input.",
    noDepthAxis: "None",
    unusedInputs: "Unused inputs: {names}",
    allInputsUsed: "Every input moves this chain.",
